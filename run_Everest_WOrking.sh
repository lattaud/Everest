...
export EDWDATADIR="/sps/edelweis/rootDataRun317/streams/prod_Midgal_eff_estimation"

#export SIMUDIR="/sps/edelweis/rootDataRun317/streams/test/$STUDY/Data"
export SIMUDIR="/sps/edelweis/rootDataRun317/streams/Efficiency_rought_Migdal/NbSi_chihalf_15V_Th/Simu" #prod_Midgal_eff_estimation"

export bigRunNb="317"

export DETECTOR="NbSi209" # NbSi209
export EVEREST_PROG_DIR="/pbs/home/h/hlattaud/Everest_from_git"

echo "calibration for run $bigRunNb"
for detPath in `ls -d1 $SIMUDIR/t[cdj]*/$DETECTOR/Line*` ; do
